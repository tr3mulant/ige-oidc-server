...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('LARAVEL_BACKUP_NAME', Str::slug(env('APP_NAME', 'ige-oidc-server'))),
        ...
        'source' => [
             ...
             */
            'databases' => [
                env('LARAVEL_BACKUP_DB_CONNECTION', env('DB_CONNECTION', 'pgsql')),
            ],
        ],
        ...
        'destination' => [
             ...
             */
            'disks' => array_map('trim', explode(',', (string) env('LARAVEL_BACKUP_DISKS', 'local'))),
         ...
         */
        'password' => env('LARAVEL_BACKUP_ARCHIVE_PASSWORD'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('LARAVEL_BACKUP_TO_ADDRESS', env('MAIL_FROM_ADDRESS', 'hello@example.com')),

            'from' => [
                'address' => env('LARAVEL_BACKUP_FROM_ADDRESS', env('MAIL_FROM_ADDRESS', 'hello@example.com')),
                'name' => env('LARAVEL_BACKUP_FROM_NAME', env('MAIL_FROM_NAME', 'Example')),
            ],
        ],

<x-guest-layout :heading="__('Sign in')" :subheading="__('Using your IGE account')">
    <!-- Session Status -->
    ...
    <form method="POST" action="{{ route('login.store') }}">
        ...
        {{-- No "don't have an account?" link: accounts are created by developers with
             `users:create`, and there is no registration route to point at. --}}
    </form>
</x-guest-layout>
